...
Tags: api, external api, rest-api, connect, custom-endpoints, endpoint, rest, zoho
...
Connect your WordPress site to external API's. Send data to API's or recieve and display API data using shortcode or template tag. Connecting to API's has never been easier. 
