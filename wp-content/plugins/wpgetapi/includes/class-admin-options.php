...
class WpGetApi_Admin_Options {
	...
	public function endpoint_fields( $type = '', $api_id = '', $base_url = '' ) {
		...
		$cache_url = $this->pro_plugin ? '<a target="_blank" href="https://wpgetapi.com/downloads/pro-plugin/?utm_campaign=Cache Pro Plugin&utm_medium=Admin&utm_source=User">Pro <span class="dashicons dashicons-external"></span></a>' : '<a target="_blank" href="https://wpgetapi.com/docs/caching-api-calls/">Help <span class="dashicons dashicons-external"></span></a>';
		...
		$endpoint_fields = apply_filters( 'wpgetapi_fields_endpoints', array(
			...
			array(
	            ...
	            'desc' => sprintf( 
	            	__( 'How many seconds to cache this request for (when set to GET method). %1s', 'wpgetapi' ),
			    	$cache_url
			    )
			),
    ...
    public function pro_banner() {
        ...
        ?>
            ...
            <div class="box pro">    
           		<h4><?php esc_html_e( 'Upgrade to the Pro Plugin', 'wpgetapi' ); ?></h4>     
                <ul>
                	<li><?php esc_html_e( 'Cache API calls', 'wpgetapi' ); ?></li>
                	<li><?php esc_html_e( 'Dynamic variables', 'wpgetapi' ); ?></li>
                	<li><?php esc_html_e( 'Get nested data', 'wpgetapi' ); ?></li>
                	<li><?php esc_html_e( 'Base64 encoding', 'wpgetapi' ); ?></li>
                	<li><?php esc_html_e( 'Format as HTML', 'wpgetapi' ); ?></li>
                	<li><?php esc_html_e( 'Format as a number', 'wpgetapi' ); ?></li>
                	<li><?php esc_html_e( 'XML format', 'wpgetapi' ); ?></li>
                </ul>  
                <a class="button" href="https://wpgetapi.com/downloads/pro-plugin/"><?php esc_html_e( 'Get the Pro Plugin', 'wpgetapi' ); ?></a>
            </div>
