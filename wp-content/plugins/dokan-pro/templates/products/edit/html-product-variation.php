        ...
        <div class="data">
            ...
            <div class="variable_pricing show_if_variable show_if_variable-subscription">
                ...
                <div class="content-half-part hide_if_variable-subscription" style="padding-right: 16px;">
                    ...
                    <span class="vendor-earning">( <?php esc_html_e( ' You Earn : ', 'dokan' ); ?><?php echo get_woocommerce_currency_symbol(); ?><span class="vendor-price"><?php echo esc_html( dokan()->commission->get_earning_by_product( $variation->ID ) ); ?></span> )</span>
