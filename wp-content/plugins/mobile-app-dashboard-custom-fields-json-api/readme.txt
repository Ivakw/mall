...
Donate link: #
Tags: mobileapp, mobile, mobile_app_dashboard, dashboard, Json_api, Json, api, cstom_fields, cstom_fields_Json_api
...
1. You can add multiple fields of different type as many as you want and save data in it.
2. This picture shows that different fields with different type of data for your mobile app so you can define even your app layout in this plugin.
3. Create a new post using ‘Custom Fields API’ type for get Jason data.
4. Hit front end of your new post and you got Jason data for your mobile APP.
5. Hit front end of your new post and send identifier value then you get only that single fiels data.
